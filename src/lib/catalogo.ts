...
export const categorias: Categoria[] = [
  ...
  { id: "brindes", nome: "Brindes", titulo: "Brindes", descricao: "Brindes para personalizar.", imagem: "", subcategorias: ["Coletes desportivos", "Sacos", "Cozinha", "Malas", "Canecas", "Bases", "Jogos"] },
];
